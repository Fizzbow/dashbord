  ...
  return (
    <ThemeProvider defaultTheme="dark" storageKey="vite-ui-theme">
      <main className="insight h-full  bg-[#111] font-Poppins flex flex-row justify-center items-center text-[#fff]">
        ...
        <section className="h-[70%] z-10 flex flex-col gap-4 w-[70%]">
          <header className="py-2  col-span-6 row-span-1 rounded-lg bg-transparent max-h-12  px-3 items-center border border-[#2D2D2D] w-full">
